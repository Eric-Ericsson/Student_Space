            ...
            <div className="p-1 border-[1px] border-gray-300">
              ...
              <ToastContainer
                ...
                <div className="p-5 flex flex-col gap-3">
                  ...
                  <div onClick={()=> {setOpenContactInfoModal(!openContactInfoModal); setOpenProfileoModal(!openProfileoModal), setAModalIsOpened(!aModalIsOpened)}} className="mt-5 text-sm text-blue-600 cursor-pointer">Edit Contact Info</div>
