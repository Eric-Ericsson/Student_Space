...
const MainNavigation = () => {
  ...
  return (
    <div
      ...
      } ease-out delay-75 duration-300 fixed flex items-center justify-between px-10 w-full h-20`}
    >
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-1">
          ...
          <span className="text-lg">Student Space</span>
        </div>
        <div className={`${scrollHeight == 'on top' && 'hidden'}`}>
          <input
            className="inputField inputFieldContainer placeholder:italic"
