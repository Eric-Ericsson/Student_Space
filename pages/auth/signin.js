            ...
            <div className="ml-10 md:ml-16 w-full">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <button onClick={() => signIn(provider.id, {callbackUrl: '/'})} className="flex items-center justify-center gap-2 text-[16px] md:border-primary-200 bg-white md:bg-none border-primary-600 rounded-3xl w-[90%] sm:w-[70%] md:w-[80%] lg:w-[60%] h-10 border-[2px]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
