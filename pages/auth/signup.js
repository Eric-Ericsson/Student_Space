  ...
  return (
    <div className="bg-blue-600 w-full min-h-screen overflow-hidden m-auto">
      <div className="md:grid grid-cols-2 h-screen">
        <div className="hidden relative md:block bg-[url('https://firebasestorage.googleapis.com/v0/b/twitter-v4-93513.appspot.com/o/myProjectImages%2Fsignup_bg.jpg?alt=media&token=c5d12976-203b-41ae-b6b8-2360eaf3ac42')] bg-no-repeat bg-cover bg-center">
        ...
        <div className="bg-[url('https://firebasestorage.googleapis.com/v0/b/twitter-v4-93513.appspot.com/o/myProjectImages%2Fsignup_bg.jpg?alt=media&token=c5d12976-203b-41ae-b6b8-2360eaf3ac42')]  bg-no-repeat bg-cover bg-center">
