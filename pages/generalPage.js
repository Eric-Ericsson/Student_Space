  ...
  return (
    <div className="bg-blue-600 w-full h-screen m-auto">
      <div className="grid md:grid-cols-2">
        <div className="hidden md:block">1</div>
        <div className="bg-blue-600 md:bg-white w-full h-screen flex flex-cols items-center">
          <div className="ml-10 md:ml-16 w-full">
            ...
            <div className="flex flex-col gap-5">
              <div>
                <button className="text-[16px] md:border-primary-200 bg-white md:bg-none border-primary-600 rounded-3xl w-[90%] sm:w-[70%] md:w-[80%] lg:w-[60%] h-10 border-[2px]">
