    ...
    <div>
      ...
      <div className="bg-[url('/signup_bg.jpg')] bg-no-repeat bg-cover bg-center">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="font-[Poppins] font-semibold text-2xl sm:text-3xl text-center text-white md:text-[#012E40] opacity-90;">Welcome Back</span>
          ...
          <InputWithLabel
                ...
                <Link href={'/signup'} className="text-xs text-white md:text-dark opacity-80 cursor-pointer md:hover:text-primary-800 hover:font-semibold">
